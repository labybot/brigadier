...
public class ArgumentCommandNode<S, T> extends CommandNode<S> {
    ...
    public ArgumentCommandNode(final String name, final ArgumentType<T> type, final Command<S> command, final Predicate<S> requirement,
        final String description, final String unmet, final boolean help, final CommandNode<S> redirect, final RedirectModifier<S> modifier, final boolean forks,
        final SuggestionProvider<S> customSuggestions) {
        super(command, requirement, description, unmet, help, redirect, modifier, forks);
        this.name = name;
        this.type = type;
